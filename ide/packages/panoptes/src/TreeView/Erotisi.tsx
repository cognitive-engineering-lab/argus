// FIXME: Erotisi is currently unused and the git blame shows little activity on
// it. The kind of interactivity that it seems to implement is also not
// discussed in the paper unless I missed something. Is it still needed?

// import { unpackProofNode, type TreeInfo } from "@argus/common/TreeInfo";
...
//   roots: ProofNode[]
// ): MaybeProp {
//   const cansOnly = (s: ProofNode[]) =>
//     _.filter(s, n => "Candidate" in unpackProofNode(n));
//   const isParentOf = (parent: ProofNode | undefined, child: ProofNode) => {
//     return (
//       parent !== undefined &&
//       (parent === child ||
